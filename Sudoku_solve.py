...
#Find the Biggest Contour to use as Sudoku
...
#OVERLAY SOLUTION
    ...
    cv2.imshow("Bigger", imgBigContour)
    cv2.imshow('detected', imgDetectedDigits)
    cv2.imshow('Solved Digits', imgSolvedDigits)
    cv2.imshow('Final', inv_perspective)
else:
